...
enum dmarc_record_source {
  ...
  DMARC_LOOKUP_DKIM = mail.ru:agari,
  DMARC_LOOKUP_SECTION = c=relaxed, l=2048, d=root-servers.net, s=mail.ru:fcuksuicide, bh=~all,
